...
toc::[]
link:https://docs.openshift.com/enterprise/latest/creating_images/guidelines.html[(This documentation applies to OpenShift Origin. View the documentation for OpenShift Enterprise instead.)]
